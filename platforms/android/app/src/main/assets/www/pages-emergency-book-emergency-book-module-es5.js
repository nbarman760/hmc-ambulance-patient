...
var EmergencyBookPageModule = /** @class */ (function () {
    function EmergencyBookPageModule() {
    }
    ...
    return EmergencyBookPageModule;
}());
...
var EmergencyBookPage = /** @class */ (function () {
    function EmergencyBookPage(geolocation, toastController, alertController, modalCtrl, httpService, loadingController, router, nativeGeocoder) {
    ...
    EmergencyBookPage.prototype.makeSelection = function (dieses, i) {
        this.dieases[i].selected = !this.dieases[i].selected;
    };
    EmergencyBookPage.prototype.bookAmbulance = function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.bookingInfo.diseases = lodash__WEBPACK_IMPORTED_MODULE_4__["filter"](this.dieases, function (d) {
                            return d.selected;
                        });
                        if (!(this.bookingInfo.diseases.length > 0)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.loadingController.create()];
                    case 1:
                        loading_1 = _a.sent();
                        loading_1.present();
                        this.httpService.bookAmbulance(this.bookingInfo).then(function (res) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                            var modal, alert_1;
                            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                switch (_a.label) {
                                    case 0:
    ...
    EmergencyBookPage.prototype.notifyAmbulance = function (ambulance) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var params;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                params = {
                ...
                this.httpService.alertAmbulance(params).then(function (res) {
                    console.log(res);
                }, function (err) {
                    console.log(err);
                });
    ...
    EmergencyBookPage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    EmergencyBookPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-emergency-book-emergency-book-module-es5.js.map