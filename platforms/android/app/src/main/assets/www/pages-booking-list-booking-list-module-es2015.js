...
let BookingListPage = class BookingListPage {
    constructor(serviceProvider, modalCtrl, alertController) {
    ...
    ngOnInit() {
        this.serviceProvider.getBookingList().then((res) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            console.log(res);
