...
var UserDetailsPage = /** @class */ (function () {
    function UserDetailsPage(userProvider, loadingController, alertController, toastController, router) {
    ...
    UserDetailsPage.prototype.ngOnInit = function () {
        ...
        if (localStorage.getItem('phone') !== undefined) {
            ...
            this.userProvider.getUserDetails(+this.userDetails.phone).then(function (res) {
    ...
    UserDetailsPage.prototype.saveDetails = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(localStorage.getItem('phone') != undefined)) return [3 /*break*/, 2];
                        this.userDetails.phone = localStorage.getItem('phone');
                    ...
                    case 1:
                        loading_1 = _a.sent();
                        loading_1.present();
                        this.userProvider.saveUserdetails(this.userDetails).then(function (res) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                            var toast, alert_1;
                            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        if (!(res.status === 'success')) return [3 /*break*/, 2];
