...
var ItemsPage = /** @class */ (function () {
    function ItemsPage(modalCtrl, router) {
    ...
    ItemsPage.prototype.fillFurniture = function () {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        modal.onDidDismiss().then(function (passData) {
                            _this.furniture = passData.data.category;
                            _this.total_items.furniture = 0;
                            for (var i = 0; i < _this.furniture.items.length; i++) {
                                _this.total_items.furniture = _this.total_items.furniture + (+_this.furniture.items[i].qty);
                            }
                        });
    ...
    ItemsPage.prototype.fillElectronics = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        modal = _a.sent();
                        modal.onDidDismiss().then(function (passData) {
                            _this.electronics = passData.data.category;
                            _this.total_items.electronics = 0;
                            for (var i = 0; i < _this.electronics.items.length; i++) {
                                _this.total_items.electronics = _this.total_items.electronics + (+_this.electronics.items[i].qty);
                            }
                        });
                        return [4 /*yield*/, modal.present()];
                    case 2: return [2 /*return*/, _a.sent()];
    ...
    ItemsPage.prototype.fillKitchen = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        modal = _a.sent();
                        modal.onDidDismiss().then(function (passData) {
                            _this.total_items.kitchen = 0;
                            _this.kitchen = passData.data.category;
                            for (var i = 0; i < _this.kitchen.items.length; i++) {
                                _this.total_items.kitchen = _this.total_items.kitchen + (+_this.kitchen.items[i].qty);
                            }
                        });
                        return [4 /*yield*/, modal.present()];
                    case 2: return [2 /*return*/, _a.sent()];
    ...
    ItemsPage.prototype.fillAccessories = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        modal = _a.sent();
                        modal.onDidDismiss().then(function (passData) {
                            _this.accessories = passData.data.category;
                            _this.total_items.accessories = 0;
                            for (var i = 0; i < _this.accessories.items.length; i++) {
                                _this.total_items.accessories = _this.total_items.accessories + (+_this.accessories.items[i].qty);
                            }
                        });
                        return [4 /*yield*/, modal.present()];
                    case 2: return [2 /*return*/, _a.sent()];
    ...
    ItemsPage.prototype.fillMiscellaneous = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        modal = _a.sent();
                        modal.onDidDismiss().then(function (passData) {
                            _this.miscellaneous = passData.data.category;
                            _this.total_items.miscellaneous = 0;
                            for (var i = 0; i < _this.miscellaneous.items.length; i++) {
                                _this.total_items.miscellaneous = _this.total_items.miscellaneous + (+_this.miscellaneous.items[i].qty);
                            }
                        });
                        return [4 /*yield*/, modal.present()];
                    case 2: return [2 /*return*/, _a.sent()];
    ...
    ItemsPage.prototype.fillVehicle = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        modal = _a.sent();
                        modal.onDidDismiss().then(function (passData) {
                            _this.vehicle = passData.data.category;
                            _this.total_items.vehicle = 0;
                            for (var i = 0; i < _this.vehicle.items.length; i++) {
                                _this.total_items.vehicle = _this.total_items.vehicle + (+_this.vehicle.items[i].qty);
                            }
                        });
                        return [4 /*yield*/, modal.present()];
                    case 2: return [2 /*return*/, _a.sent()];
    ...
    ItemsPage.prototype.proceedToaddress = function () {
        var jsonItems = {
