...
let LoginPage = class LoginPage {
    constructor(userProvider, toastController, loadingController, modalCtrl, alertController, router) {
    ...
    sentOtp() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if (this.user.phone.match(phoneno)) {
                ...
                loading.present();
                this.userProvider.sentOtp(this.user).then((res) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                    loading.dismiss();
